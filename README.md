...
| :--- | :--- | :--- | :--- |
| **[`people-agent-mesh`](https://github.com/pedrogriff/people-agent-mesh)**<br>[`[Live Demo]`](https://playgriff.me/people-agent-mesh/)<br>[`[Staff Whitepaper]`](https://github.com/pedrogriff/people-agent-mesh/blob/main/docs/STAFF-SYSTEM-DESIGN.md) | Enterprise multi-agent orchestration, Model Context Protocol (MCP) server, human-in-the-loop (HITL) governance, and automated evaluation platform for sensitive People Operations across Brazil 🇧🇷 (CLT/LGPD), United States 🇺🇸 (FLSA/Title VII), and Canada 🇨🇦 (PIPEDA). Implements a stateful checkpointed supervisor DAG with pause/resume execution, zero-retention PII/SPII tokenization (CPF/SSN/SIN) with cryptographic shredding (LGPD Art. 18), adversarial prompt injection defense with heuristic threat scoring, XML delimiter sandboxing, high-entropy canary tripwires, LLM-as-a-Judge semantic rubrics (Faithfulness, Constructive Tone, Demographic Neutrality), demographic counterfactual parity testing ($\Delta \le 0.0001$), standardized MCP server over stdio and SSE for Claude Desktop & Cursor, an interactive FastAPI web showcase UI, and automated CI quality gates blocking eval regressions. | Python 3.13, Model Context Protocol (MCP), Stateful Multi-Agent DAG, LLM-as-a-Judge, Counterfactual Parity, Adversarial Defense, FastAPI Showcase UI, Pydantic v2, Zero-Retention PII Tokenizer, ABAC Security Trimming, Circuit Breakers, OpenTelemetry GenAI, Pytest, Golden Evals | [![CI](https://github.com/pedrogriff/people-agent-mesh/actions/workflows/ci.yml/badge.svg)](https://github.com/pedrogriff/people-agent-mesh/actions)<br>[![Live Demo](https://img.shields.io/badge/Live%20Demo-playgriff.me-blue?style=flat&logo=googlechrome&logoColor=white)](https://playgriff.me/people-agent-mesh/)<br>[![MCP Server](https://img.shields.io/badge/MCP-Protocol%202024--11--05-8A2BE2.svg)](https://github.com/pedrogriff/people-agent-mesh/blob/main/docs/MCP-SERVER-GUIDE.md)<br>[![Staff Design](https://img.shields.io/badge/Staff%20Design-Whitepaper-blue.svg)](https://github.com/pedrogriff/people-agent-mesh/blob/main/docs/STAFF-SYSTEM-DESIGN.md) |
